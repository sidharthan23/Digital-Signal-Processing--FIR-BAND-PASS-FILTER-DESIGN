...
hn=hd.*wh 
% Plot the Band Pass Filter with Hamming Window Technique
w=0:0.01:pi; 
h=freqz(hn,1,w); 
plot(w/pi,abs(h),'ms');
```
## OUTPUT:
![WhatsApp Image 2025-11-27 at 5 11 53 PM](https://github.com/user-attachments/assets/9d1e5f93-823a-40e4-a29f-0c3276cafb82)



## RESULT:
![WhatsApp Image 2025-11-27 at 5 12 15 PM](https://github.com/user-attachments/assets/5d9fe648-06fb-4831-aa77-c294ba1670e0)
